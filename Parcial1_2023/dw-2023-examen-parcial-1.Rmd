...
* Esta tecnica se llama broadcasting, esta permite que se hagan operaciones entre vectores 
La técnica que describe se llama "broadcasting". Broadcasting es una técnica en programación numérica que permite operar entre arrays de diferentes formas de manera eficiente y coherente. Cuando se realiza una operación entre dos arrays de diferentes dimensiones, NumPy en Python (y R de manera similar) "transmite" automáticamente los elementos del array más pequeño para que sean compatibles con el array más grande.
